...
class Config(BaseSettings):
    ...
    flow_direction_asset_prefixes: Union[str, set[str]] = {'Equipment/', 'Piping/Endpoint/Pagination'}
    ...
    symbol_label_for_connectors: Union[str, set[str]] = {'Piping/Endpoint/Pagination'}
